...
public class LoadUpdate extends AsyncTask<Void, Comic, Void> {

    @SuppressLint("StaticFieldLeak")
    private HomeScreenActivity mActivity;

    public LoadUpdate(HomeScreenActivity activity)
    {
        mActivity = activity;
    }
    ...
    protected Void doInBackground(Void... voids) {
        ...
        Query query;
        query = databaseReference.orderByChild("id").limitToLast(6);
    ...
    protected void onProgressUpdate(Comic... comics) {
        ...
        mActivity.addToListUpdate(comics[0]);
    }
}
